...
public:
  ...
  /// Try to publish a rclcpp::SerializedMessage via loaned message.
  /**
   * If publisher cannot borrow loaned message, it will call publish().
   */
  void try_publish_loaned_msg(const rclcpp::SerializedMessage & message);
